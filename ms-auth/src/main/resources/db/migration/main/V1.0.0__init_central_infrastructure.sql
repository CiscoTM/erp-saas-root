-- /home/dev50/proyectos/erp-saas-root/ms-auth/src/main/resources/db/migration/V1.0.0__init_central_infrastructure.sql
...
-- Añadir soporte Outbox en la base central
...
CREATE INDEX IF NOT EXISTS idx_central_outbox_status ON outbox_events(status);