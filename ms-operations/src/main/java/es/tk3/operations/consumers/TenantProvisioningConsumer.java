...
public class TenantProvisioningConsumer extends AbstractTenantProvisioningConsumer {
    ...
    @KafkaListener(topics = "core.tenant.events", groupId = "operations-tenant-provisioning")
    public void consumeTenantEvent(String payload){
        processTenantProvisioning(payload, flywayLocations, "flyway_schema_history_operations", "OPERATIONS");
    }
}
